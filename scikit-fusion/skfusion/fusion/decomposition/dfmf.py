...
class Dfmf(FusionFit):
    ...
    def fuse(self, fusion_graph):
        ...
        # parallelizer = Parallel(n_jobs=self.n_jobs, max_nbytes=1e3, verbose=self.verbose, backend="multiprocessing")
        parallelizer = Parallel(n_jobs=self.n_jobs, max_nbytes=1e3, verbose=self.verbose, backend="loky")
